...
const Dashboard = ({ token }) => {
  ...
  const fetchChartData = async () => {
    try {
      ...
      if (response.data.success) {
        console.log("Chart Data Response:", response.data.data); // 💡 Thêm dòng này
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-4 flex gap-2">
        <button
          className={`px-4 py-2 rounded ${mode === "day"
        ...
        <button
          className={`px-4 py-2 rounded ${mode === "month"
            ? "bg-blue-500 text-white"
            : "bg-gray-200 text-gray-700"
            }`}
        ...
        <button
          className={`px-4 py-2 rounded ${mode === "product"
            ? "bg-blue-500 text-white"
            : "bg-gray-200 text-gray-700"
            }`}
